...
if (selected == 'Heart Disease Prediction'):
    ...
    with col1:
        thal = st.text_input('thal: 0 = normal; 1 = defect; 2 = reversable defect')
    ...
    if st.button('Find Heart Disease Test Result'):
        heart_prediction = heart_disease_model.predict([[age, sex, cp, trestbps, chol, fbs, restecg,thalach,exang,oldpeak,slope,ca,thal]])                          
        
        if (heart_prediction[0] == 1):
          heart_diagnosis = 'The person is having heart disease'
        else:
          heart_diagnosis = 'The person might not have any heart disease'
...
if (selected == 'Lung Cancer Prediction'):
    ...
    with col2:
        slope1 = st.text_input('Slope of the peak exercise ST')
        
    with col3:
        ca1 = st.text_input('Major vessels colored by ')
    ...
    if st.button('Lung Cancer Test Result'):
        cancer_prediction = lung_cancer_model.predict([[age, sex, cp, trestbps, chol, fbs, restecg,thalach,exang,oldpeak,slope,ca,thal,slope1,ca1]])                          
        
        if (cancer_prediction[0] == 1):
            cancer_diagnosis = 'The person might have lung cancer'
        else:
